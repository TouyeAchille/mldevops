...
# load in the data
df=pd.read_csv("/Users/achillejuniormbogoltouye/Documents/mldevops/starter/data/census.csv")
...
X_test, y_test, encoder,lb, scaler = process_data(
    test, categorical_features=cat_features, label="salary", training=False, lb=lb, encoder=encoder, scaler=scaler)
...
# save model
filename = "/Users/achillejuniormbogoltouye/Documents/mldevops/starter/model/clf_model.pkl"
...
filename = "/Users/achillejuniormbogoltouye/Documents/mldevops/starter/model/encoder.pkl"
save_pickle(filename)
print('='*10)
